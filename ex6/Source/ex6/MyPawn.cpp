...
void AMyPawn::MoveForward()
{
	...
	// 		// this next line allows me to log the input forward vector so I can debug issues
	// // UE_LOG(GamePlayLog, Warning, TEXT("MyPawn MoveForward: (%f, %f, %f)"), forward.X, forward.Y, forward.Z);
